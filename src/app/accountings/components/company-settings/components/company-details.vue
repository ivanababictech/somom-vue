            ...
            <v-card class="grey lighten-4 elevation-0 mb-3">
                ...
                <v-card-text>
                    ...
                    <v-layout row>
                        <v-flex xs4>
                            <v-text-field
                                    ...
                                    v-model="company.details.sharesCount"
                                    type="number"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs4>
                            <v-text-field
                                    ...
                                    v-model="company.details.sharesType"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs4>
                            <v-text-field
                                    label="Class of shares"
                                    v-model="company.details.sharesClass"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs4>
                            <v-text-field
                                    label="Value per shares"
                                    v-model="company.details.shareValue"
                                    type="number"
                            ></v-text-field>
                        </v-flex>
                    </v-layout>
                    ...
                    <v-layout row>
                        <v-flex xs5>
                            <v-text-field
                                    label="Address 1"
                                    v-model="company.details.address1"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs5>
                            <v-text-field
                                    label="Address 2"
                                    v-model="company.details.address2"
                            ></v-text-field>
                        </v-flex>
                        <v-flex xs2>
                            <v-text-field
                                    label="City"
                                    v-model="company.details.city"
                            ></v-text-field>
                        </v-flex>
                    </v-layout>
                ...
                <v-card-text>
                    ...
                    <v-layout row>
                        ...
                        <v-flex xs1>
                            <v-btn fab dark small color="success" @click="addDirector('Corporate')">
                    ...
                    <v-layout row>
                        ...
                        <v-flex xs1>
                            <v-spacer></v-spacer>
                            <v-btn fab dark small color="success" @click="addDirector('Individual')">
                                <v-icon dark>add</v-icon>
                            </v-btn>
                        </v-flex>
                    </v-layout>
                ...
                <v-card-text>
                    ...
                    <v-layout row>
                        ...
                        <v-flex xs1>
                            <v-btn fab dark small color="success" @click="addShareholder('Corporate')">
                                <v-icon dark>add</v-icon>
                            </v-btn>
                        </v-flex>
                    </v-layout>
                    ...
                    <v-layout row>
                        ...
                        <v-flex xs1>
                            <v-btn fab dark small color="success" @click="addShareholder('Individual')">
                                <v-icon dark>add</v-icon>
                            </v-btn>
                        </v-flex>
                    </v-layout>
                ...
                <v-card-text>
                    ...
                    <v-layout row class="relative">
                        ...
                        <v-btn fab dark small color="success" absolute top right class="mt-4" @click="addEmployee">
                            <v-icon>add</v-icon>
                        </v-btn>
                    </v-layout>
    ...
    export default {
        ...
        computed: {
            ...mapGetters({
                ...
                companyDetails: 'accounting/company',
            }),
        },
        ...
        methods: {
            ...
            init() {
                this.company = JSON.parse(JSON.stringify(this.companyDetails))
