<template>
    <v-flex xs10 offset-xs1 class="mt-4">
        ...
        <v-layout mt-4>
            <span class="subheading">1. Obtained an understanding about the company selling & distribution expenses</span>
        </v-layout>
        <v-layout>
        ...
        <v-layout mt-4>
            <span class="subheading">3.  Selected a sample of selling & distribution invoices and traced to  accounting entries</span>
        </v-layout>
        <selling-distribution-invoice-table :invoices="sellingDistributionInvoices"></selling-distribution-invoice-table>

        <v-layout mt-4>
            <span class="subheading">4.  Determined whether there are any related party selling & distribution expenses</span>
        </v-layout>
        <v-layout row>
            <v-flex xs3>
                <v-layout row fill-height align-center>
                    <span>Where there any related party S&D?</span>
                </v-layout>
            </v-flex>
            <v-flex xs3 ml-3>
                <v-radio-group v-model="related_party_sd" row hide-details class="mt-0">
                    <v-radio label="Yes" :value="1"></v-radio>
                    <v-radio label="No" :value="0"></v-radio>
                </v-radio-group>
            </v-flex>
        </v-layout>
        <v-layout row v-if="related_party_sd">
            <v-flex xs3>
        ...
        <selling-distribution-invoice-table :invoices="sellingDistributionInvoices" v-if="debit_notes_received"></selling-distribution-invoice-table>

        <v-layout mt-4>
            <span class="subheading">7.  Determined whether journal entries related to S&D , if any, are correctly stated.</span>
        </v-layout>
        <v-layout row>
            <v-flex xs3>
                <v-layout row fill-height align-center>
                    <span>Where there any journal entries related to Selling & Distribution expenses?</span>
                </v-layout>
            </v-flex>
            <v-flex xs3 ml-3>
        ...
        <v-layout mt-4>
            <span class="subheading">9. Obtained supporting documentation related to Selling & Distribution expenses</span>
        </v-layout>
        <v-btn class="success">Copy of selling & distribution expenses invoices</v-btn>
...
<script>
    ...
    import sellingDistributionInvoiceTable from './tables/selling-distribution-invoice.vue'
    ...
    export default {
        ...
        components: {
            ...
            sellingDistributionInvoiceTable,
            journalEntriesTable,
            salesGoodsTable,
        },
        data: () => ({
