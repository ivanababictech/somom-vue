<template>
    <v-flex xs10 offset-xs1 class="mt-4">
        ...
        <v-layout mt-4>
            <span class="subheading">1. Obtained an understanding about the company administrative expenses</span>
        </v-layout>
        <v-layout>
        ...
        <v-layout mt-4>
            <span class="subheading">3.  Selected a sample of administrative invoices and traced to  accounting entries</span>
        </v-layout>
        <administrative-invoice-table :invoices="administrativeInvoices"></administrative-invoice-table>

        <v-layout mt-4>
            <span class="subheading">4.  Determined whether there are any related party purchases.</span>
        </v-layout>
        <v-layout row>
            <v-flex xs3>
        ...
        <administrative-invoice-table :invoices="administrativeInvoices" v-if="debit_notes_received"></administrative-invoice-table>

        <v-layout mt-4>
            <span class="subheading">7.  Determined whether journal entries related to administrative expenses, if any, are correctly stated.</span>
        </v-layout>
        <v-layout row>
            <v-flex xs3>
                <v-layout row fill-height align-center>
                    <span>Where there any journal entries related to administrative expenses?</span>
                </v-layout>
            </v-flex>
            <v-flex xs3 ml-3>
        ...
        <v-layout mt-4>
            <span class="subheading">9. Obtained supporting documentation related to administrative expenses</span>
        </v-layout>
        <v-btn class="success">Copy of administrative expenses invoices</v-btn>
...
<script>
    ...
    import administrativeInvoiceTable from './tables/administrative-invoice.vue'
