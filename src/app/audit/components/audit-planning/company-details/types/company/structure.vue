<template>
    <v-card>
                ...
                <v-layout row wrap v-for="(type, index) in structure.types" :key="index">
                    <v-layout row>
                        ...
                        <v-flex xs2 v-if="type.value === 'individual'">
                            <v-btn dark small color="info" @click="openInputDetails(type)">
                                Input Details
                            </v-btn>
                        </v-flex>
                        ...
                        <v-flex xs2 class="text-xs-right">
                            ...
                            <v-btn fab dark small color="error" @click="removeType(index)">
                    ...
                    <template v-if="type.value == 'company'">
                        ...
                        <v-layout row v-for="(shareholder, index) in type.shareholders" :key="index">
                            ...
                            <v-flex xs3>
                                <v-btn dark small color="info" @click="openInputDetails(shareholder)">
                                    Input Details
                                </v-btn>
                            </v-flex>
                            <v-flex xs3 class="text-xs-right">
                                ...
                                <v-btn
                                        ...
                                        small
                                        color="danger"
                                        v-if="type.shareholders.length > 1"
                                        @click="removeShareholder(type, index)">
                                    <v-icon dark>remove</v-icon>
                                </v-btn>
                            </v-flex>
                        </v-layout>
                    ...
                    <template v-if="type.value == 'foundation'">
                        ...
                        <v-layout row v-for="(beneficiary, index) in type.beneficiaries" :key="index">
                            ...
                            <v-flex xs2 class="text-xs-right">
                                ...
                                <v-btn fab dark small color="error" v-if="type.beneficiaries.length > 1" @click="removeBeneficiary(type, index)">
                                    <v-icon dark>remove</v-icon>
                                </v-btn>
                            </v-flex>
                        </v-layout>
        ...
        <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="blue darken-1" flat @click.native="resetStructure();">Reset</v-btn>
            <v-btn color="blue darken-1" flat @click.native="structure.show = false">Save</v-btn>
        </v-card-actions>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addShareholder(type) {
                type.shareholders.unshift(JSON.parse(JSON.stringify(this.shareholderStructure)))
            },
            ...
            addBeneficiary(type) {
                type.beneficiaries.unshift(JSON.parse(JSON.stringify(this.beneficiaryStructure)))
            },
