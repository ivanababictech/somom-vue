        ...
        <v-card-text v-for="item in items" :key="item.uuid">
            ...
            >
                ...
                <template slot="expand" slot-scope="props">
                    <v-data-table :headers="headers" :items="items.data" item-key="ii_id" dark hide-actions>
                        <template slot="items" slot-scope="props">
        ...
        data () {
            return {
                headers: [
                    ...
                    { text: 'Enter amount', value: 'new_value'},
                    { text: 'Currency', value: 'new_value', width: '100px'},
                    { text: 'Interest rate', value: 'new_value', width: '100px'},
